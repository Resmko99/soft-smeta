...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Пользователь успешно создан', type: user_entity_1.User }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', type: 'number' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Пользователь обновлён', type: user_entity_1.User }),
    __param(0, (0, common_1.Param)('id')),
